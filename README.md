Este projeto se trata da criação de um serviço básico de mensagens criptografadas usando a criptografia RSA (Rivest-Shamir-Adleman), que usa de chaves públicas para a encriptação e chaves privadas para a decriptação de mensagens.
